...
public class FillPhoneWorldDb {
    ...
    public void postConstruct() {
        //TODO;
        //Timestamp timestamp; Dont know if i should use Timestamp as an argument in add methods
        ...
        AdTeam5 a1 = addAd(u1,p1,"selling nokia 3310","awesome phone",StatusTeam5.ACTIVE);
        AdTeam5 a2 = addAd(u2,p2,"selling nokia 3210","bad phone",StatusTeam5.ACTIVE);
        BidTeam5 b1 = addBid(a2,u1,1000);
        u1.getBids().add(b1);
        a2.getBids().add(b1);
        CommentTeam5 c1 = addComment("nokia is bad", u2, a1);
        CommentTeam5 c2 = addComment("nokia is super cool", u1, a2);
